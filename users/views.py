...
def kakao_callback(request):
    try:
        ...
        nickname = email.split("@")[
            0
        ]  # properties.get("nickname")  # return None / 2022-01-05 check!
        profile_image = (
...
class UpdateProfileView(mixins.LoggendInOnlyView, SuccessMessageMixin, UpdateView):
    model = models.User
